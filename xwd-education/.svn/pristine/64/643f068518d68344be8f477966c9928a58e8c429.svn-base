			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tbody>
					...
					<tr>
						...
						<td class="span3" align="left"><form:input path="numbers"
								htmlEscape="false" maxlength="50" class="required" />&nbsp;<font
							color="red">*</font></td>
					    <td class="span2" align="center">桥梁类型:</td>
						<td class="span3" align="left"><form:input path="bridge.dic.label" readonly="true"
								htmlEscape="false" maxlength="50"/></td>
					</tr>
					<tr>
						<td class="span2" align="center">所属机构:</td>
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${bearing.offc.name}"
