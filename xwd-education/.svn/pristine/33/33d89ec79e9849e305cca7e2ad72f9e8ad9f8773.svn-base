...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/jqline?catalog=${catalog}">JQ线列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/jqline/form?catalog=${catalog}">JQ线添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="jqLine" action="${ctx}/device/electricity/cne/jqline/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
