...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="insulatorClean"
			action="${ctx}/inf/nk/insulatorclean/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/insulatorclean/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
