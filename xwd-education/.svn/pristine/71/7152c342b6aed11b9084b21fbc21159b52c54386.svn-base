...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/tem/powersupplyeq?catalog=${catalog}">设备列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/tem/powersupplyeq/form?catalog=${catalog}">设备添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="powersupplyeq" action="${ctx}/device/electricity/tem/powersupplyeq/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
