...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/autotransformer?catalog=${catalog}">变压器列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/autotransformer/form?catalog=${catalog}">变压器添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="autotransformer" action="${ctx}/device/electricity/cne/autotransformer/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
