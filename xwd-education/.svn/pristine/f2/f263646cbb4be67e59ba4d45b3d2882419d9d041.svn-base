...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/portalStructure?catalog=${catalog}">硬横跨列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/portalStructure/form?catalog=${catalog}">硬横跨添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="portalStructure" action="${ctx}/device/electricity/cne/portalStructure/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td class="span2">硬横跨编号:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="portalNo" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
