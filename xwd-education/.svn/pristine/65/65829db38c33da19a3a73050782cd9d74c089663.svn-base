...
<body>
	...
	<form:form id="inputForm" modelAttribute="subgradeProtect" action="${ctx}/data/work/subgradeprotect/save"
				...
				<tr>
						...
						<td class="span3" align="left">				
			                 <form:select path="ass.id" class="required" style="width:150px" >
		                        ...
		                        <form:options items="${fns:getAssetCardList(subgradeProtect.cat.id)}" itemLabel="name" itemValue="id" htmlEscape="false"/>
		                    </form:select>
							<font color="red">*</font>
						</td>
					...
					<tr>
						...
						<td class="span3" align="left"><form:input path="slopeL" htmlEscape="false" maxlength="50" class="required"/>&nbsp;<font color="red">*</font></td>
						<td class="span2" align="center">所属机构:</td>
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${subgradeProtect.offc.name}"
