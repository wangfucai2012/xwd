...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="addConductor"
			action="${ctx}/inf/nk/addconductor/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.awcdPole}</td>
				<td style="text-align: center;">${entity.trackNumber}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/addconductor/view?id=${entity.awcdId}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
