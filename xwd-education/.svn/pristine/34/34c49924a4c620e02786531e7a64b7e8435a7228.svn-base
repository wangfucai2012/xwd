...
<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/data/work/oilpipelines?catalog=${oilPipelines.cat.id}">油管线添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oilPipelines" action="${ctx}/data/work/oilpipelines/save"
			...
			cellspacing="1" bgcolor="#dddddd" class="table table-striped table-bordered table-hover">
				<tbody>
					<tr>
						...
						<td class="span3" align="left">				
			                 <form:select path="ass.id" class="required" style="width:150px" >
		                        ...
		                        <form:options items="${fns:getAssetCardList(oilPipelines.cat.id)}" itemLabel="name" itemValue="id" htmlEscape="false"/>
		                    </form:select>
							<font color="red">*</font>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="span3" align="left"><form:input path="pNumber" htmlEscape="false" maxlength="50" class="required abc"/>&nbsp;<font color="red">*</font></td>
					...
					<tr>
						...
						<td class="span3" align="left"><form:input path="medium" htmlEscape="false" maxlength="50" class="required"/>&nbsp;<font color="red">*</font></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${oilPipelines.offc.name}"
