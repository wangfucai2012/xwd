...
public class UserController extends BaseController {
	...
	public String save(User user, String oldLoginName, String newPassword, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			...
			return "redirect:/sys/user/?repage";// "+Global.getAdminPath()+"
		}
	...
	public List<User> findAll() {
		List<User> userList = systemService.findUserList();
        return userList;
	}
...
//    }
	...
	public String modifyPwd(String oldPassword, String newPassword, Model model) {
		...
		if (StringUtils.isNotBlank(oldPassword) && StringUtils.isNotBlank(newPassword)){
			...
			if (SystemService.validatePassword(oldPassword, user.getSalt(), user.getPassword())){
				systemService.updatePasswordById(user, newPassword);
				// .updatePasswordById(user.getId(), user.getLoginName(), newPassword);
