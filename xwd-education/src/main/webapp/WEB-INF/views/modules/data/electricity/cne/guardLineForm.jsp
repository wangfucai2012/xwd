...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/guardLine?catalog=${catalog}">保护线列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/guardLine/form?catalog=${catalog}">保护线添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="guardLine" action="${ctx}/device/electricity/cne/guardLine/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
