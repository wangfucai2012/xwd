...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/afline?catalog=${catalog}">AF线列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/afline/form?catalog=${catalog}">AF线添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="afLine" action="${ctx}/device/electricity/cne/afline/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
