...
<ul class="nav nav-tabs">
    ...
    <li><a href="${ctx}/data/dynamicinfo/splice/form">基础信息添加</a></li>
    <li><a href="${ctx}/data/dynamicinfo/splicedynamic?spliceId=${spliceDynamic.splice.id}">接头信息列表</a></li>
    <li  class="active"><a href="${ctx}/data/dynamicinfo/splicedynamic/form?spliceId=${spliceDynamic.splice.id}">接头信息添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="spliceDynamic" action="${ctx}/data/dynamicinfo/splicedynamic/save" method="post">
    <form:hidden path="id"/>
