...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/tem/dcacdisc?catalog=${catalog}">设备列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/tem/dcacdisc/form?catalog=${catalog}">设备添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="dcacDisc" action="${ctx}/device/electricity/tem/dcacdisc/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="span3" style="text-align: left;">
                    <form:input path="runNum" htmlEscape="false" maxlength="50"/>
                </td>
            </tr>
           <tr>
            ...
            <tr>
                <td class="span2">整流方式:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="zlType" htmlEscape="false" maxlength="50" class="required"/>
                </td>
