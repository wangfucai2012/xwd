...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/suppleLine?catalog=${catalog}">供电线列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/suppleLine/form?catalog=${catalog}">供电线添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="suppleLine" action="${ctx}/device/electricity/cne/suppleLine/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
