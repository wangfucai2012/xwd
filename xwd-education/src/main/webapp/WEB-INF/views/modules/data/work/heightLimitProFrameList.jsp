...
<body>
<form:hidden path="heightLimitProFrame.cat.id"/>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/data/work/heightlimitproframe?catalog=${heightLimitProFrame.cat.id}">防护架列表</a></li>
		<li><a href="${ctx}/data/work/heightlimitproframe/form?catalog=${heightLimitProFrame.cat.id}">防护架添加</a></li>
	</ul>
	<div class="searchBar">	
	<form:form id="searchForm" modelAttribute="heightLimitProFrame"
		action="${ctx}/data/work/heightlimitproframe?catalog=${heightLimitProFrame.cat.id}" method="post"
	...
	<table id="contentTable"
		...
		<tr>
			...
			<th style="text-align: center;">桥涵通行净高</th>
			<th style="text-align: center;">下穿道路等级</th>
			<th style="text-align: center;">路面形式</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">&nbsp;${entity.throughHeight}</td>
				<td style="text-align: center;">&nbsp;${entity.roadLevel}</td>
				<td style="text-align: center;">&nbsp;${entity.roadType}</td>
				<td style="text-align: center;">
				<a href="${ctx}/data/work/heightlimitproframe/form?id=${entity.id}&catalog=${entity.cat.id}">修改</a>
				&nbsp;<a href="${ctx}/data/work/heightlimitproframe/delete?id=${entity.id}&catalog=${entity.cat.id}"
