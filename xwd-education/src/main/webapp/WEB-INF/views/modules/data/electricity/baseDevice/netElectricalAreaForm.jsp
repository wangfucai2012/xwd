...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/baseDevice/netElectricalArea/">工区列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/baseDevice/netElectricalArea/form">工区添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="entity" action="${ctx}/device/electricity/baseDevice/netElectricalArea/save" method="post" enctype="multipart/form-data">
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="span3" style="text-align: left;">
                    <form:input path="startM" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">结束里程：</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="endM" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
