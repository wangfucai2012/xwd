...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/baseDevice/substation?catalog=${catalog}">变电所列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/baseDevice/substation/form?catalog=${catalog}">变电所添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="substation" action="${ctx}/device/electricity/baseDevice/substation/save?catalog=${catalog}" method="post" enctype="multipart/form-data" >
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="span3" style="text-align: left;">
                    <form:input path="centerM" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
