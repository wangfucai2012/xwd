...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/returnLine?catalog=${catalog}">回流线列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/returnLine/form?catalog=${catalog}">回流线添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="returnLine" action="${ctx}/device/electricity/cne/returnLine/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
