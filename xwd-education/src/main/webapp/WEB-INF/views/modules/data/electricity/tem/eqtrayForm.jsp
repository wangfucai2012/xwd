...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/tem/eqtray?catalog=${catalog}">设备盘装置</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/tem/eqtray/form?catalog=${catalog}">设备盘添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="eqtray" action="${ctx}/device/electricity/tem/eqtray/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
           ...
           <tr>
                <td class="span2">交流盘:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="extray" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">直流盘:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="dirtray" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">控制盘:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="contray" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">保护盘:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="protray" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">计量盘:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="mestray" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">信号盘:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="sigtray" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
