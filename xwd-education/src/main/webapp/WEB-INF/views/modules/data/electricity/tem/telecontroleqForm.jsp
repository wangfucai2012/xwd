...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/tem/telecontroleq?catalog=${catalog}">远动装置</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/tem/telecontroleq/form?catalog=${catalog}">装置添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="telecontroleq" action="${ctx}/device/electricity/tem/telecontroleq/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
