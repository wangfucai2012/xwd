...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/tem/malfunctionjudgmentdevice?catalog=${catalog}">设备列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/tem/malfunctionjudgmentdevice/form?catalog=${catalog}">设备添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="malfunctionJudgmentDevice" action="${ctx}/device/electricity/tem/malfunctionjudgmentdevice/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
