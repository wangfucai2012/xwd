...
<form:hidden path="protectiveNet.cat.id"/>
	...
	<form:form id="searchForm" modelAttribute="protectiveNet"
		action="${ctx}/data/work/protectivenet?catalog=${protectiveNet.cat.id}" method="post"
	...
	<table id="contentTable"
		...
		<tr>
			...
			<th style="text-align: center;">防护网规格</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">&nbsp;${entity.specification}</td>
				<td style="text-align: center;">
				...
				&nbsp;<a href="${ctx}/data/work/protectivenet/delete?id=${entity.id}&catalog=${entity.cat.id}"
