...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/feederLine?catalog=${catalog}">馈电线列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/feederLine/form?catalog=${catalog}">馈电线添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="feederLine" action="${ctx}/device/electricity/cne/feederLine/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
