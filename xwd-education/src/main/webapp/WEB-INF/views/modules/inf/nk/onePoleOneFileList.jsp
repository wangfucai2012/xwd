...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="onePoleOneFile"
			action="${ctx}/inf/nk/onepoleonefile/" method="post"
			...
			<div>
				<label>部门名称：</label>
				<form:input path="departmentName" htmlEscape="false" maxlength="50" class="input-small"/>
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">线路条件</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.line}</td>
				<td style="text-align: center;">${entity.mileage}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/onepoleonefile/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
