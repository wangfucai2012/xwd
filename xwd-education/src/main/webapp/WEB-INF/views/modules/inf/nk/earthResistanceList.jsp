...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="earthResistance"
			action="${ctx}/inf/nk/earthresistance/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.grPole}</td>
				<td style="text-align: center;">${entity.grCheckDate}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/earthresistance/view?id=${entity.grId}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
