...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="mainEleCircle"
			action="${ctx}/inf/nk/mainelecircle/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.mectPole}</td>
				<td style="text-align: center;">${entity.mectCheckDate}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/mainelecircle/view?id=${entity.mectId}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
