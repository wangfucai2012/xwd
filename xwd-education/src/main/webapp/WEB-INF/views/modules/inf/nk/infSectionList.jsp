...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="infSection"
			action="${ctx}/inf/nk/infsection/" method="post"
			...
			<div>
				<label>区间名称：</label>
				<form:input path="blockName" htmlEscape="false" maxlength="50" class="input-small"/>
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/infsection/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
