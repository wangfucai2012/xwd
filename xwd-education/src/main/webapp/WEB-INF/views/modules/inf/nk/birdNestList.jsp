...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="birdNest"
			action="${ctx}/inf/nk/birdnest/" method="post"
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">鸟巢位置</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.pole}</td>
				<td style="text-align: center;">${entity.trackNumber}</td>
				<td style="text-align: center;">${entity.nestPosition}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/birdnest/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
