...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="fourCPole"
			action="${ctx}/inf/nk/fourcpole/" method="post"
			...
			<div>
				<label>站/区间：</label>
				<form:input path="stationName" htmlEscape="false" maxlength="50" class="input-small"/>
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/fourcpole/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
