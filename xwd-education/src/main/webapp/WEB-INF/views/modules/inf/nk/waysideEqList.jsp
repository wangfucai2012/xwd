...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="waysideEq"
			action="${ctx}/inf/nk/waysideeq/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.miuPole}</td>
				<td style="text-align: center;">${entity.miuCheckDate}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/waysideeq/view?id=${entity.miuId}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
