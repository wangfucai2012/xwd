...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="noCrossBranch42"
			action="${ctx}/inf/nk/nocrossbranch42/" method="post"
			...
			<div>
				<label>区间(站场)：</label>
				<form:input path="ncb42Block" htmlEscape="false" maxlength="50" class="input-small"/>
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">道岔号</th>
			<th style="text-align: center;">工区</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
                ...
                <c:set var="string3" value="${fn:substring(string1, 3,6)}"/>K${string2}+${string3}
                 ...
                 --%> 
				<td style="text-align: center;">${entity.ncb42Block}</td>
				<td style="text-align: center;">${entity.ncb42TurnoutNo}</td>
				<td style="text-align: center;">${entity.ncb42WorkArea}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/nocrossbranch42/view?id=${entity.ncb42Id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
