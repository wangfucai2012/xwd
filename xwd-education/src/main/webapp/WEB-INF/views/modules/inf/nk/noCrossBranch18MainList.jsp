...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="noCrossBranch18Main"
			action="${ctx}/inf/nk/nocrossbranch18main/" method="post"
			...
			<div>
				<label>杆号：</label>
				<form:input path="ncbPole" htmlEscape="false" maxlength="50" class="input-small"/>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
                ...
                <c:set var="string3" value="${fn:substring(string1, 3,6)}"/>K${string2}+${string3}
                 ...
                 --%> 
				<td style="text-align: center;">${entity.ncbPole}</td>
				<td style="text-align: center;">${entity.ncb18Block}</td>
				<td style="text-align: center;">${entity.ncb18TurnoutNo}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/nocrossbranch18main/view?id=${entity.ncb18Id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
