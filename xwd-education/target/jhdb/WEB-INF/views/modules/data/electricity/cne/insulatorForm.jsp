...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/insulator?catalog=${catalog}">绝缘子列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/insulator/form?catalog=${catalog}">绝缘子添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="insulator" action="${ctx}/device/electricity/cne/insulator/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td class="span2">绝缘子类型:</td>
                <td class="span3">
                    <form:input path="type" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">绝缘子材质:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="material" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
