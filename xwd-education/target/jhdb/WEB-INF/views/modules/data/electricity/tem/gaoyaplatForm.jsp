...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/tem/gaoyaplat?catalog=${catalog}">高压柜列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/tem/gaoyaplat/form?catalog=${catalog}">记录添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="gaoyaplat" action="${ctx}/device/electricity/tem/gaoyaplat/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="span3" style="text-align: left;">
                    <form:input path="type" htmlEscape="false" maxlength="50" class="required userName"/>
                </td>
            </tr>
            <tr>
                <td class="span2">运行编号:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="runNumber" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
           <tr>
                <td class="span2">额定电压:</td>
                <td class="span3" style="text-align: left;">
                    <form:input path="ratedVoltage" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">主要部件构成:</td>
                <td class="span3" style="text-align: left;">
