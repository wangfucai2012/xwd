...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/tem/comautoeq?catalog=${catalog}">装置列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/tem/comautoeq/form?catalog=${catalog}">装置添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="comautoeq" action="${ctx}/device/electricity/tem/comautoeq/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="span3" style="text-align: left;">
                    <form:input path="node" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
