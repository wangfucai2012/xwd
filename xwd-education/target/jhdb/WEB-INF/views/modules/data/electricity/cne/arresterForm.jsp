...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/arrester?catalog=${catalog}">避雷器列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/arrester/form?catalog=${catalog}">避雷器添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="arrester" action="${ctx}/device/electricity/cne/arrester/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td class="span2">引线距接地体最小距离:</td>
                <td class="span3">
                    <form:input path="minimumRange" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td class="span2">引线弛度:</td>
                <td class="span3">
                    <form:input path="lineChi" htmlEscape="false" maxlength="50" class="required"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
