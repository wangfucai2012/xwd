...
<head>
    ...
    <script>
        ...
        function page(n, s) {
            $("#pageNo").val(n);
            $("#pageSize").val(s);
            $("#searchForm").attr("action", "${ctx}/data/dynamicinfo/splicedynamic?&spliceId=${spliceDynamic.splice.id}");
            $("#searchForm").submit();
            return false;
        }
    </script>
...
<ul class="nav nav-tabs">
    <li ><a href="${ctx}/data/dynamicinfo/splice">基础信息列表</a></li>
    <li  class="active"><a href="${ctx}/data/dynamicinfo/splicedynamic?spliceId=${spliceDynamic.splice.id}">接头详细信息</a></li>
</ul>
...
<form:form id="searchForm" modelAttribute="spliceDynamic"
    ...
    <input id="orderBy" name="orderBy" type="hidden"
          ...
          <label>日期：</label>
				...
				&nbsp;&nbsp;	<a href="${ctx}/data/dynamicinfo/splicedynamic?&spliceId=${spliceDynamic.splice.id}" class="btn "
...
<table id="contentTable" class="table table-striped table-bordered table-hover">
    ...
    <c:forEach items="${page.list}" var="list" varStatus="i">
        <tr>
            ...
            <shiro:hasPermission name="sys:user:edit">
                <td><a href="${ctx}/data/dynamicinfo/splicedynamic/form?id=${list.id}&spliceId=${spliceDynamic.splice.id}">修改</a> <a
                        href="${ctx}//data/dynamicinfo/splicedynamic/delete?id=${list.id}"
