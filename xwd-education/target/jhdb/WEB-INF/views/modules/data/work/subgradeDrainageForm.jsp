...
<body>
	...
	<form:form id="inputForm" modelAttribute="subgradeDrainage" action="${ctx}/data/work/subgradedrainage/save"
				   ...
				   <tr>
						...
						<td class="span3" align="left">				
			                 <form:select path="ass.id" class="required" style="width:150px" >
		                        ...
		                        <form:options items="${fns:getAssetCardList(subgradeDrainage.cat.id)}" itemLabel="name" itemValue="id" htmlEscape="false"/>
		                    </form:select>
							<font color="red">*</font>
						</td>
					...
					<tr>
						...
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${subgradeDrainage.offc.name}"
