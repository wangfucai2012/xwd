...
<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/data/work/securityzonesigns/form?catalog=${securityZoneSigns.cat.id}">标桩添加</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="securityZoneSigns" action="${ctx}/data/work/securityzonesigns/save"
			...
			cellspacing="1" bgcolor="#dddddd" class="table table-striped table-bordered table-hover">
				<tbody>
					<tr>
						...
						<td class="span3" align="left"><form:input path="workShop" htmlEscape="false" maxlength="50" class="required"/>&nbsp;<font color="red">*</font></td>  
						...
						<td class="span3" align="left">				
			                 <form:select path="ass.id" class="required" style="width:150px" >
		                        ...
		                        <form:options items="${fns:getAssetCardList(securityZoneSigns.cat.id)}" itemLabel="name" itemValue="id" htmlEscape="false"/>
		                    </form:select>
							<font color="red">*</font>
						</td>
					</tr>
					<tr>
						...
						<td class="span3"  align="left"><form:input path="outStream" htmlEscape="false" maxlength="50" class="required abc"/>&nbsp;<font color="red">*</font></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="span3" align="left"><form:input path="signType" htmlEscape="false" maxlength="50" class="required abc"/>&nbsp;<font color="red">*</font></td>
						<td class="span2" align="center">设计距离:</td>
						<td class="span3" align="left"><form:input path="designLength" htmlEscape="false" maxlength="50" class="required"/>&nbsp;<font color="red">*</font></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${securityZoneSigns.offc.name}"
