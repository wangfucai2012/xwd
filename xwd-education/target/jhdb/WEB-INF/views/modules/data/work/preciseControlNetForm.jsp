...
<body>
	...
	<form:form id="inputForm" modelAttribute="preciseControlNet" action="${ctx}/data/work/precisecontrolnet/save"
			...
			cellspacing="1" bgcolor="#dddddd" class="table table-striped table-bordered table-hover">
				<tbody>
					...
					<tr>
						...
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${entity.offc.name}"
