...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="infCompensation"
			action="${ctx}/inf/nk/infcompensation/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.cdPole}</td>
				<td style="text-align: center;">${entity.cdCheckDate}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/infcompensation/view?id=${entity.cdId}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
