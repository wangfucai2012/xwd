...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="infSubStationEq"
			action="${ctx}/inf/nk/infsubstationeq/" method="post"
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">所亭名</th>
			<th style="text-align: center;">设备类型名称</th>
			<th style="text-align: center;">所亭类型</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.stationType}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/infsubstationeq/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
