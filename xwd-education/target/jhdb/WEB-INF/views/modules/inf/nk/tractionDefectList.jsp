...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="tractionDefect"
			action="${ctx}/inf/nk/tractiondefect/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/tractiondefect/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
