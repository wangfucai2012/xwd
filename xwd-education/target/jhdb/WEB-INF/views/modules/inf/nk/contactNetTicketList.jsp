...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="contactNetTicket"
			action="${ctx}/inf/nk/contactnetticket/" method="post"
			...
			<div>
				<label>工作票号：</label>
				<form:input path="recorderJobTicket" htmlEscape="false" maxlength="50" class="input-small"/>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
                ...
                <c:set var="string3" value="${fn:substring(string1, 3,6)}"/>K${string2}+${string3}
                 ...
                 --%> 
				<td style="text-align: center;">${entity.recorderJobTicket}</td>
				<td style="text-align: center;">${entity.checkDate}</td>
				<td style="text-align: center;">${entity.teamLeader}</td>
				<td style="text-align: center;">${entity.teamWorker}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/contactnetticket/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
