...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="electricBox"
			action="${ctx}/inf/nk/electricbox/" method="post"
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">所属工区名称</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/electricbox/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
