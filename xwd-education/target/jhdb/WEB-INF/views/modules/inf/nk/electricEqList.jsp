...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="electricEq"
			action="${ctx}/inf/nk/electriceq/" method="post"
			...
			<div>
				<label>所名称：</label>
				<form:input path="elecStationName" htmlEscape="false" maxlength="50" class="input-small"/>
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">所名称</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
                ...
                <c:set var="string3" value="${fn:substring(string1, 3,6)}"/>K${string2}+${string3}
                 ...
                 --%> 
				<td style="text-align: center;">${entity.elecStationName}</td>
				<td style="text-align: center;">${entity.equipName}</td>
				<td style="text-align: center;">${entity.runType}</td>
				<td style="text-align: center;">${entity.mileage}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/electriceq/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
