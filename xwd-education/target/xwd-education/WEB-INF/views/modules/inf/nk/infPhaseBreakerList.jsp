...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="infPhaseBreaker"
			action="${ctx}/inf/nk/infphasebreaker/" method="post"
	 ...
	 <thead>	
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.siPole}</td>
				<td style="text-align: center;">${entity.siCheckDate}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/infphasebreaker/view?id=${entity.siId}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
