...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="fourCbatValue"
			action="${ctx}/inf/nk/fourcbatvalue/" method="post"
			...
			<div>
				<label>线路名称：</label>
				<form:input path="lineName" htmlEscape="false" maxlength="50" class="input-small"/>
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">线路编码</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.lineCode}</td>
				<td style="text-align: center;">${entity.lineName}</td>
				<td style="text-align: center;">${entity.direction}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/fourcbatvalue/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
