...
<body>
	<div class="searchBar">	
		<form:form id="searchForm" modelAttribute="crossingPointWiring"
			action="${ctx}/inf/nk/crossingpointwiring/" method="post"
	 ...
	 <thead>	
		<tr>
			...
			<th style="text-align: center;">股道号</th>
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">${entity.tlpPole}</td>
				<td style="text-align: center;">${entity.trackNumber}</td>
				<td style="text-align: center;">${entity.clbTurnoutNo}</td>
				
				<td style="text-align: center;">
				<a href="${ctx}/inf/nk/crossingpointwiring/view?id=${entity.id}">查看</a>
                </td>
			</tr>
		</c:forEach>
		</tbody>
