	...
	<form:form id="inputForm" modelAttribute="cameraLocation" action="${ctx}/data/comm/cameralocation/save" method="post" class="form-horizontal">
		...
		<div class="cs-detial1">
			...
			cellspacing="1" bgcolor="#dddddd" class="table table-striped table-bordered table-hover">
				<tbody>
					<tr>
					    <td class="span2">位置:</td>
						<td class="span3" align="left"><form:input path="location"  htmlEscape="false" maxlength="50" class="required"/>
						&nbsp;<font color="red">*</font>
						</td>
					</tr>
					<tr>
					    <td class="span2">名称:</td>
						<td class="span3" align="left"><form:input path="name"  htmlEscape="false" maxlength="50" class="required"/>
						&nbsp;<font color="red">*</font>
						</td>
					</tr>
					<tr>
						<td class="span2">中心里程:</td>
						<td class="span3" align="left"><form:input path="centerM" htmlEscape="false" maxlength="50" class="required"/>
						&nbsp;<font color="red">*</font>
						</td>
					</tr>
					</tbody>
