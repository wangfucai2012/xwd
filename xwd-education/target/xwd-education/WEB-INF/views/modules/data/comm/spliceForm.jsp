...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/data/comm/splice">接头列表</a></li>
    <li  class="active"><a href="${ctx}/data/comm/splice/form">接头添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="splice" action="${ctx}/data/comm/splice/save" method="post">
    <form:hidden path="id"/>
