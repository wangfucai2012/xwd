...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/baseDevice/anchor?catalog=${entity.cat.id}">锚段列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/baseDevice/anchor/form?catalog=${entity.cat.id}">锚段添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="anchor" action="${ctx}/device/electricity/baseDevice/anchor/save" method="post" enctype="multipart/form-data" >
    <form:hidden path="id"/>
    ...
    <div class="cs-detail">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <td class="span3" style="text-align: left;">
                    <form:select path="pss.id" id="pss.id" class="required">
