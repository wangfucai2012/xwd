...
<ul class="nav nav-tabs">
    <li><a href="${ctx}/device/electricity/cne/boostingwire?catalog=${catalog}">吸上线列表</a></li>
    <li  class="active"><a href="${ctx}/device/electricity/cne/boostingwire/form?catalog=${catalog}">吸上线添加</a></li>
</ul>

<form:form id="inputForm" modelAttribute="boostingWire" action="${ctx}/device/electricity/cne/boostingwire/save?catalog=${catalog}" method="post">
    <form:hidden path="id"/>
