...
<form:hidden path="subgradeProtect.cat.id"/>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/data/work/subgradeProtect?catalog=${subgradeProtect.cat.id}">防护列表</a></li>
		<li><a href="${ctx}/data/work/subgradeprotect/form?catalog=${subgradeProtect.cat.id}">防护添加</a></li>
	</ul>
	<div class="searchBar">	
	<form:form id="searchForm" modelAttribute="subgradeProtect"
		action="${ctx}/data/work/subgradeprotect?catalog=${subgradeProtect.cat.id}" method="post"
	...
	<table id="contentTable"
		...
		<c:forEach items="${page.list}" var="entity">
			...
			<tr>
				...
				<td style="text-align: center;">
				<a href="${ctx}/data/work/subgradeprotect/form?id=${entity.id}&catalog=${entity.cat.id}">修改</a>
				&nbsp;<a href="${ctx}/data/work/subgradeprotect/delete?id=${entity.id}&catalog=${entity.cat.id}"
