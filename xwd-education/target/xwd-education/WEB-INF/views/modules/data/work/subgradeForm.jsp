...
<body>
	...
	<form:form id="inputForm" modelAttribute="subgrade" action="${ctx}/data/work/subgrade/save"
				...
				<tr>
						...
						<td class="span3" align="left">				
			                 <form:select path="ass.id" class="required" style="width:150px" >
		                        ...
		                        <form:options items="${fns:getAssetCardList(subgrade.cat.id)}" itemLabel="name" itemValue="id" htmlEscape="false"/>
		                    </form:select>
							<font color="red">*</font>
						</td>
					...
					<tr>
						...
						<td class="span3" align="left"><form:input path="height" htmlEscape="false" maxlength="50" class="required"/>&nbsp;</td>
						<td class="span2" align="center">所属机构:</td>
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${subgrade.offc.name}"
