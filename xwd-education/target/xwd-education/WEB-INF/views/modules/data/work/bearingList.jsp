...
<body>
<form:hidden path="bearing.cat.id"/>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/data/work/bearing?catalog=${bearing.cat.id}">支座列表</a></li>
		<li><a href="${ctx}/data/work/bearing/form?catalog=${bearing.cat.id}">支座添加</a></li>
	</ul>
	<div class="tableBar">
	<div class="searchBar">	
	<form:form id="searchForm" modelAttribute="bearing"
		action="${ctx}/data/work/bearing?catalog=${bearing.cat.id}" method="post"
		...
		<input id="pageSize" name="pageSize" type="hidden"
			...
			<div>
				...
				<form:input path="cat.id" value="${requestScope.bearing.cat.id}" htmlEscape="false" maxlength="50" class="input-small" type="hidden"/>
	...
	<table id="contentTable"
	  ...
	  <thead>
		...
		<!-- 	<td style="text-align: center;">${entity.pier.pnumber}</td>  -->	
				...
				<td style="text-align: center;"style="text-align: left;">
					<a href="${ctx}/data/work/bearing/form?id=${entity.id}&catalog=${entity.cat.id}">修改</a>
					&nbsp;<a href="${ctx}/data/work/bearing/delete?id=${entity.id}&catalog=${entity.cat.id}"
