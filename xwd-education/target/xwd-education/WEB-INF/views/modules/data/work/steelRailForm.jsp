...
<ul class="nav nav-tabs">
	...
	<form:form id="inputForm" modelAttribute="steelRail" action="${ctx}/data/work/steelrail/save"
			...
			cellspacing="1" bgcolor="#dddddd" class="table table-striped table-bordered table-hover">
				<tbody>
					<tr>
						...
						<td class="span3" align="left">				
			                 <form:select path="ass.id" class="required" style="width:150px" >
		                        ...
		                        <form:options items="${fns:getAssetCardList(steelRail.cat.id)}" itemLabel="name" itemValue="id" htmlEscape="false"/>
		                    </form:select>
							<font color="red">*</font>
						</td>
					...
					<tr>
						...
						<td class="span3" align="left">
						<sys:treeselect id="office" name="offc.id" value="${offc.id}" labelName="offc.name" labelValue="${steelRail.offc.name}"
