...
<head>
    ...
    $(document).ready(function () {
        ajax("${ctx}/data/dynamicinfo/splice/getNetarea","",function (msg) {
    ...
    function getBaseStation(start, end) {
        ...
        ajax("${ctx}/data/dynamicinfo/splice/getBaseStation",data,function (msg) {
            closeTip();
...
<ul class="nav nav-tabs">
    <li class="active"><a href="${ctx}/data/dynamicinfo/splice">接头列表</a></li>
    <li  ><a href="${ctx}/data/dynamicinfo/splice/form">接头添加</a></li>
</ul>

<!--查询框start-->
<form:form id="searchForm" modelAttribute="splice"
           method="post" action="${ctx}/data/dynamicinfo/splice" 
    ...
    <input id="orderBy" name="orderBy" type="hidden"
           ...
           <label>基       站：</label>
				...
				&nbsp;&nbsp;	<a href="${ctx}/data/dynamicinfo/splice" class="btn "
...
<table id="contentTable" class="table table-striped table-bordered table-hover">
    ...
    <c:forEach items="${page.list}" var="list" varStatus="i">
        <tr>
            ...
            <shiro:hasPermission name="sys:user:edit">
                <td><a href="${ctx}/data/dynamicinfo/splice/form?id=${list.id}">修改</a> <a
                        href="${ctx}//data/dynamicinfo/splice/delete?id=${list.id}"
                        onclick="return confirmx('确认要删除该数据吗？', this.href)">删除</a>
                        <a href="${ctx}/data/dynamicinfo/splicedynamic?spliceId=${list.id}">详细信息</a>
                        <a href="${ctx}/data/dynamicinfo/splicedynamic/form?spliceId=${list.id}&">添加详细</a></td>
            </shiro:hasPermission>
        </tr>
    </c:forEach>
    </tbody>
