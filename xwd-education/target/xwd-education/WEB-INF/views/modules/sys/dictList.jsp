...
<body>
	...
	<form:form id="searchForm" modelAttribute="dict" action="${ctx}/sys/dict/" method="post" class="form-search">
		...
		&nbsp;&nbsp;<label>描述 ：</label><form:input path="remark" htmlEscape="false" maxlength="50" class="input-medium"/>
		&nbsp;<input id="btnSubmit" class="btn btn-primary" type="submit" value="查询"/>&nbsp;&nbsp;&nbsp;&nbsp;<input id="btn" class="btn" type="reset" value="重置"/>
	</form:form>
	</div>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover ">
		...
		<c:forEach items="${page.list}" var="dict">
			<tr>
				...
				<td>${dict.remark}</td>
				<td style="text-align:center;">${dict.sort}</td>
				<shiro:hasPermission name="sys:dict:edit"><td style="text-align:center;">
    				...
    				|&nbsp;<a href="${ctx}/<c:url value='sys/dict/form?type=${dict.type}&sort=${dict.sort+10}'><c:param name='description' value='${dict.remark}'/></c:url>">添加键值</a>
